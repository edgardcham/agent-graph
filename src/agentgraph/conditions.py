...
def when(condition: Callable[[State], bool]) -> Callable[[State], bool]:
    """Create named condition for readability"""
    return condition


def has_field(field: str) -> Callable[[State], bool]:
...
def field_exists(field: str) -> Callable[[State], bool]:
...
def field_equals(field: str, value: Any) -> Callable[[State], bool]:
...
def field_not_equals(field: str, value: Any) -> Callable[[State], bool]:
...
def field_gt(field: str, value: Union[int, float]) -> Callable[[State], bool]:
...
def field_ge(field: str, value: Union[int, float]) -> Callable[[State], bool]:
...
def field_lt(field: str, value: Union[int, float]) -> Callable[[State], bool]:
...
def field_le(field: str, value: Union[int, float]) -> Callable[[State], bool]:
...
def field_in(field: str, values: Container[Any]) -> Callable[[State], bool]:
...
def field_not_in(field: str, values: Container[Any]) -> Callable[[State], bool]:
...
def field_contains(field: str, value: Any) -> Callable[[State], bool]:
...
def field_len_equals(field: str, length: int) -> Callable[[State], bool]:
...
def field_len_gt(field: str, length: int) -> Callable[[State], bool]:
...
def field_is_true(field: str) -> Callable[[State], bool]:
...
def field_is_false(field: str) -> Callable[[State], bool]:
...
def field_is_none(field: str) -> Callable[[State], bool]:
...
def field_is_not_none(field: str) -> Callable[[State], bool]:
...
def field_type_is(field: str, expected_type: type) -> Callable[[State], bool]:
...
def all_conditions(*conditions: Callable[[State], bool]) -> Callable[[State], bool]:
...
def any_conditions(*conditions: Callable[[State], bool]) -> Callable[[State], bool]:
...
def not_condition(condition: Callable[[State], bool]) -> Callable[[State], bool]:
    """Negate a condition"""
...
def custom_condition(
    name: str,
) -> Callable[[Callable[[State], bool]], Callable[[State], bool]]:
    """Create a custom named condition decorator"""

    def decorator(func: Callable[[State], bool]) -> Callable[[State], bool]:
        @wraps(func)
